...
With no other influences, the thermodynamic equlibrium of ortho- to para-D$_2$ at 25 K is 0.995, but radiation-induced recombination of the deuterium molucules resuts in an equilibrium ratio of 0.762 for 1.2 mA of proton current on the SINQ target \cite{op_equi}.  This ratio gradually returns to thermodynamic equilibrium when the beam is shut off.  The proton current on SINQ prior to the brightness measurement is shown in Figure \ref{fig:p_current}.  The was a steady period of XXX mA for XXX days, with a period of zero current for XXX time before the measurement was taken.  From this history, the o/p fraction should have been around XXX.  There is some uncertainty in this value, however, and Figure \ref{fig:op_compare} shows the variation in the emitted neutron spectrum caused by a o/p ratio change from 0.66 (room temperature equlibrium) to 0.995 (25 K equlibrium) when the deuterium is at nominal saturation density of 0.162 g/cm$^3$ at 25 K \cite{bnl_cryo}.
