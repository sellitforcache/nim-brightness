...
\begin{gather}
     \label{eqn:eff1} \epsilon = \exp \left(-\Sigma_{\textrm{stl}}(\lambda) x_{\textrm{stl}}\right)[1-\exp(-\Sigma_{\textrm{He}}(\lambda) D_{\textrm{He}})] \\
...
\begin{figure}[h!] 
  \centering
    \includegraphics[width=\textwidth]{graphics/eff.eps}
     \caption{The efficiency curves. \label{geom} }
\end{figure}
