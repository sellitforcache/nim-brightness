...
\begin{enumerate}
  ...
  \item Iron pinhole collimator, surrounded by heavy concrete and polyethylene shielding
  \item Cadmium aperture, 1 mm $\oslash$, at end of pinhole collimator, xxx cm form detector
  \item Sapphire crystals, XXX cm total thickness, within the heavy concrete and polyethylene shielding
  \item Evacuated flight tubes with XXX mm thick aluminum faces, total length 
  \item Lead and heavy concrete collimator, XXxXX mm aperature at xxx cm from detector
\end{enumerate}
\begin{center}\underline{In-pile components}\end{center}
\begin{enumerate}[resume]
  \item Moveable Gd aperature wheel
